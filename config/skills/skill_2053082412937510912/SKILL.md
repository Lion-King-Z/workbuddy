...
description: >-
  Novel writing assistant with character management, worldbuilding, outline control, and chapter generation. Features plot thread tracking, character cards, world templates, and quality review. Supports wuxia, urban, sci-fi, and fantasy genres. Triggers: 写小说, 创作小说, 人物设定, 世界观, 大纲, 章节生成, novel writing, character creation.
